...
import static apisteps.PostApiCalls.createPost;
import static apisteps.PostApiCalls.deletePost;
import static apisteps.PostApiCalls.getPostById;
import static apisteps.PostApiCalls.getPosts;
import static apisteps.PostApiCalls.partialUpdatePost;
import static apisteps.PostApiCalls.updatePost;
...
public class PostsTests {
    ...
    public void partialUpdatePostTest() {
        ...
        PostModel post = step("Отправить PATCH запрос для частичного обновления поста на эндпоинт '/posts/{id}'",
                () -> partialUpdatePost(body, postId, 200)
                        .extract().as(PostModel.class));
